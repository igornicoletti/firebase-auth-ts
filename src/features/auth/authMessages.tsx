...
const authMessages: AuthMessageProps[] = [
  ...
  {
    code: 'auth/user-not-found', title
      : 'User not found',
  ...
  },
  {
    ...
    description: 'The reset password link is invalid or has expired. Please request a new one.'
  },
  {
    code: 'auth/missing-oob-code',
    title: 'Missing code',
    description: 'The reset link is incomplete or missing. Please try again.'
  },
  {
