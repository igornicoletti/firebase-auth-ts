...
type DialogProviderState = {
  openDialog: (options: DialogProviderValues) => void
  closeDialog: () => void
}
...
export const DialogProvider = ({
  ...
  const [options, setOptions] = useState<DialogProviderValues>({})
  const optionsRef = useRef<DialogProviderValues>({})

  const openDialog = (opts: DialogProviderValues) => {
    setOptions(opts)
